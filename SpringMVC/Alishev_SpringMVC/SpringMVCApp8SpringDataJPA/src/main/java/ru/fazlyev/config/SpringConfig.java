...
@Configuration
@ComponentScan("ru.fazlyev")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("ru.fazlyev.repositories")
...
//        sessionFactory.setPackagesToScan("ru.fazlyev.models");
//        sessionFactory.setHibernateProperties(hibernateProperties());
//
//        return sessionFactory;
//    }

    // В БИНЕ ПРОБЛЕМА , НЕ МОЖЕТ СОЗДАТЬ, ИЗ ЗА ЭТОГО 500 ОШИБКА НА СЕРВЕРЕ!!!!!!!!!!!!!!!!!!
    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        final LocalContainerEntityManagerFactoryBean em = new LocalContainerEntityManagerFactoryBean();
        em.setDataSource(dataSource());
        em.setPackagesToScan("ru.fazlyev.models");
